...
import SuccessPopup from "../../Register/Succespopup";
...
const RegisterPageClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await registerClient(formData.email, formData.password, {
        name: formData.name,
      ...
      console.log("Usuario registrado con éxito:", formData.email);
