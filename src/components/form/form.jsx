...
const SquareCheckbox = ({ checked, onChange, label }) => (
  <label className="flex items-center space-x-2 cursor-pointer">
    <div
      className={`w-4 h-4 border-2 ${checked ? "bg-[#714dbf] border-[#714dbf]" : "border-gray-400"} rounded-sm flex items-center justify-center`}
    >
      {checked && (
        <svg
...
export default function FormularioPostulacion() {
  ...
  const validateForm = () => {
    ...
    if (
      formData.registradoSII === null ||
      formData.registradoSII === undefined
    ) {
    ...
    if (
      formData.inicioActividadesSII === null ||
      formData.inicioActividadesSII === undefined
    ) {
    ...
    if (!formData.cedulaFrente.url || formData.cedulaFrente.uploading) {
      ...
      newErrorMessages.cedulaFrente =
        "Debes subir la cédula de identidad (frente)";
      isValid = false;
    } else {
    ...
    if (!formData.cedulaReverso.url || formData.cedulaReverso.uploading) {
      ...
      newErrorMessages.cedulaReverso =
        "Debes subir la cédula de identidad (reverso)";
      isValid = false;
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const hasMissingDocs = requiredDocs.some(
        (doc) => !doc.url || doc.uploading,
      );
      if (hasMissingDocs) {
        throw new Error(
          "Debes subir todos los documentos requeridos y esperar a que se completen las subidas",
        );
      }
      ...
      const userUpdateData = {
        ...
        additionalCertificate: formData.certificadoAdicional
          ? { url: formData.certificadoAdicional.url }
          : null,
        // Datos bancarios:
    ...
    <div className="min-h-screen w-full bg-white">
      <div className="sticky top-0 bg-white z-10 py-4 px-4 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-gray-800 cursor-pointer">
      ...
      <div className="max-w-2xl mx-auto p-4 pt-6">
        <div className="border border-gray-300 rounded-lg p-6 bg-white shadow-sm">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div
                  className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.registradoSII ? "border border-red-500" : ""}`}
                >
                  ...
                  <div className="flex space-x-4">
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("registradoSII", true)
                      }
                      label="Sí"
                    />
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("registradoSII", false)
                      }
                      label="No"
                    />
                  </div>
                </div>
                {errors.registradoSII && (
                  <p className="mt-1 text-sm text-red-600">
                    {errorMessages.registradoSII}
                  </p>
                )}

                <div
                  className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.inicioActividadesSII ? "border border-red-500" : ""}`}
                >
                  <span className="text-sm font-medium text-gray-700">
                  ...
                  <div className="flex space-x-4">
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("inicioActividadesSII", true)
                      }
                      label="Sí"
                    />
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("inicioActividadesSII", false)
                      }
                      label="No"
                    />
                  </div>
                </div>
                {errors.inicioActividadesSII && (
                  <p className="mt-1 text-sm text-red-600">
                    {errorMessages.inicioActividadesSII}
                  </p>
                )}

                <div
                  className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.movilizacion ? "border border-red-500" : ""}`}
                >
                  <span className="text-sm font-medium text-gray-700">
                  ...
                  <div className="flex space-x-4">
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("movilizacion", true)
                      }
                      label="Sí"
                    />
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("movilizacion", false)
                      }
                      label="No"
                    />
                  </div>
                ...
                {errors.movilizacion && (
                  <p className="mt-1 text-sm text-red-600">
                    {errorMessages.movilizacion}
                  </p>
                )}

                <div
                  className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.herramientas ? "border border-red-500" : ""}`}
                >
                  <span className="text-sm font-medium text-gray-700">
                    ¿Posees herramientas propias? *
                  </span>
                  <div className="flex space-x-4">
                    <SquareCheckbox
                      checked={formData.herramientas === true}
                      onChange={() =>
                        handleCheckboxChange("herramientas", true)
                      }
                      label="Sí"
                    />
                    <SquareCheckbox
                      ...
                      onChange={() =>
                        handleCheckboxChange("herramientas", false)
                      }
                      label="No"
                    />
                  </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div
                className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.cedulaFrente ? "border border-red-500" : ""}`}
              >
                <div>
              ...
              {errors.cedulaFrente && !formData.cedulaFrente.name && (
                <p className="mt-1 text-sm text-red-600">
                  {errorMessages.cedulaFrente}
                </p>
              )}

              <div
                className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.cedulaReverso ? "border border-red-500" : ""}`}
              >
                <div>
                  <label className="block text-sm font-medium text-gray-700">
              ...
              {errors.cedulaReverso && !formData.cedulaReverso.name && (
                <p className="mt-1 text-sm text-red-600">
                  {errorMessages.cedulaReverso}
                </p>
              )}

              <div
                className={`bg-gray-100 p-4 rounded-lg flex justify-between items-center ${errors.certificadoAntecedentes ? "border border-red-500" : ""}`}
              >
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                ...
                <label className="cursor-pointer">
                  <input
                    ...
                    className="hidden"
                    onChange={(e) =>
                      handleFileChange(e, "certificadoAntecedentes")
                    }
                    accept="image/*,application/pdf"
                  />
                  <FiPaperclip className="text-[#714dbf] text-xl" />
              ...
              {errors.certificadoAntecedentes &&
                !formData.certificadoAntecedentes.name && (
                  <p className="mt-1 text-sm text-red-600">
                    {errorMessages.certificadoAntecedentes}
                  </p>
                )}
              ...
              <div className="bg-gray-100 p-4 rounded-lg flex justify-between items-center">
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                    Certificado Adicional (Opcional)
                  </label>
                ...
                <label className="cursor-pointer">
                  <input
                    ...
                    className="hidden"
                    onChange={(e) =>
                      handleFileChange(e, "certificadoAdicional")
                    }
                    accept="image/*,application/pdf"
                  />
                  <FiPaperclip className="text-[#714dbf] text-xl" />
      ...
      {showSuccessPopup && <FormSuccessPopup onClose={handleClosePopup} />}
    </div>
  );
}
