...
import IconPendingComplete from "../../../../assets/IconPendingComplete.png";
const Icons = {
  // Servicios / Tipos
  otros: OtrosIcon,
  plagas: PlagasIcon,
  artefactos: ArtefactosIcon,
  jardinería: JardineriaIcon, // Con tilde
  pintura: PinturaIcon,
  albañilería: AlbaneriaIcon, // Con tilde y ñ
  carpintería: CarpinteriaIcon, // Con tilde
  climatización: ClimatizacionIcon, // Con tilde
  seguridad: SeguridadIcon,
  limpieza: LimpiezaIcon,
  cerrajería: CerrajeriaIcon, // Con tilde
  electricidad: ElectricidadIcon,
  gasfitería: GasfiteriaIcon, // Con tilde
