        ...
        <div className="border-b-2 border-gray-200 mb-5 pb-4 py-5 px-5">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <img src="./src/assets/profile.png" alt="profileIcon" />
              ...
              <div className="flex justify-between items-start p-1">
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-left mt-2">
                    <p className="text-gray-800 font-bold mr-1">
            ...
            <div className="space-y-1">
              <div className="flex items-center">
                ...
                <span className="text-gray-600">
                  {profile.commune || "No proporcionado"}
                </span>
              </div>
              <div className="flex items-center">
                <span className="font-semibold text-gray-700 w-24">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-600">
                  {profile.email || "No proporcionado"}
                </span>
              </div>
            </div>
          ...
          {reviewsLoading ? (
            ...
            <div className="bg-[#eaecf6] rounded-lg p-4">
              {displayedReviews.map((review) => (
                <div
                  key={review.id}
                  className="border-b border-gray-300 pb-4 mb-4 last:border-0 last:mb-0 last:pb-0"
                >
