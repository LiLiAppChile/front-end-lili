  ...
  return (
    <div className="min-h-screen bg-white p-4">
      ...
      <div className="flex flex-col items-center justify-center bg-gray-100 p-4 rounded-lg mb-4">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Para verificar tu cuenta debes completar el siguiente formulario:
        </p>
        <button
          onClick={() => navigate("/form")}
          className="btn-promociones bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition w-60"
        >
      ...
      {/* Ajusta el valor de mb-16 según la altura del BottomMenu */}
      <BottomMenu />
    </div>
  );
};
